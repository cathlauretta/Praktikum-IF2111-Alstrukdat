...
int hitungfrekuensi(){
    ...
    while(!IsEOP()){//melakukan looping hingga EOP
        ...
        else if (t_found==true&&i_found==true&&(GetCC()=='g'||GetCC()=='G')){//melakukan pengecekan apakah karakter yang dibaca g/G dan karakter sebelumnya adalah i/I yang diawali dengan t/T
            g_found=true;
        }
        else if (t_found==true&&i_found==true&&g_found==true&&(GetCC()=='a'||GetCC()=='A')){//melakukan pengecekan apakah karakter yang dibaca a/A dan karakter sebelumnya adalah g/G yang diawali dengan t/T dan i/I
    ...
    /*
        notes: perhatikan testcase-testcase yang unik, misalkan:
        ttiga.
        tigaaa.
        ttigaa.
    */
